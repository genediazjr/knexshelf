...
exports.defaults = function (schema) {
    ...
    defaults.browse = async function (query, opts) {
        ...
        const cached = await lib.internals.cache.get(key);
        ...
        await lib.internals.cache.set(key, JSON.stringify(result));
    ...
    defaults.create = async function (payload, opts) {
        ...
        await lib.internals.broadcast(schema.schema.name, JSON.stringify({
            method: 'create',
            payload: result
        }));
    ...
    defaults.scrimp = async function (payload, opts) {
        ...
        if (payload.id) {
            ...
            return await defaults.update({ id: payload.id }, payload, opts);
        }

        return await defaults.create(payload, opts);
    };
